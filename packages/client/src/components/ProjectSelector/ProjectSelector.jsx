...
const ProjectSelector = ({ onProjectSelect, selectedBranches, onBranchesChange, isLoading: externalLoading }) => {
  ...
  console.warn('Branches loaded:', data);
  ...
  setError(null);
  setLoading(true);
  console.warn('Selecting repository:', folderPath);
  ...
  const data = await response.json();
  console.warn('Repository selected:', data);
  ...
  setError(null);
  setLoading(true);
  console.warn('Selecting recent repository:', repoPath);
