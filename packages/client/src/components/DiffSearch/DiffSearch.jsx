...
const DiffSearch = ({ onSearch, initialFilters = {}, initialQuery = '' }) => {
  ...
  ...prev,
  [category]: Array.isArray((Object.hasOwn(prev, category) ? (Object.hasOwn(prev, category) ? prev[category] : undefined) : undefined)) ? 
  (Object.hasOwn(prev, category) ? (Object.hasOwn(prev, category) ? prev[category] : undefined) : undefined).includes(value) ?
    (Object.hasOwn(prev, category) ? (Object.hasOwn(prev, category) ? prev[category] : undefined) : undefined).filter(item => item !== value) :
    [...(Object.hasOwn(prev, category) ? (Object.hasOwn(prev, category) ? prev[category] : undefined) : undefined), value] :
  [value]
  }));
  };
  ...
  setActiveFilters(prev => {
  const current = Array.isArray((Object.hasOwn(prev, category) ? (Object.hasOwn(prev, category) ? prev[category] : undefined) : undefined)) ? (Object.hasOwn(prev, category) ? (Object.hasOwn(prev, category) ? prev[category] : undefined) : undefined) : [];
  ...
  return Array.isArray((Object.hasOwn(activeFilters, category) ? (Object.hasOwn(activeFilters, category) ? activeFilters[category] : undefined) : undefined)) && (Object.hasOwn(activeFilters, category) ? (Object.hasOwn(activeFilters, category) ? activeFilters[category] : undefined) : undefined).includes(value);
  };
