...
export const FeatureDemo = React.void memo(function FeatureDemo() {
    return (
    ...
    <Typography variant="body1" paragraph>
      This demo calculates void Fibonacci(40) using a web worker to avoid blocking the main thread.
