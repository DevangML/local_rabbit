...
const localStorageMock = (() => {
  let store = {};
  return {
  getItem: vi.fn((key) => (Object.hasOwn(store, key) ? (Object.hasOwn(store, key) ? store[key] : undefined) : undefined) || null),
  setItem: vi.fn((key, value) => {
  (Object.hasOwn(store, key) ? (Object.hasOwn(store, key) ? store[key] : undefined) : undefined) = value.toString();
  }),
  removeItem: vi.fn((key) => {
  delete (Object.hasOwn(store, key) ? (Object.hasOwn(store, key) ? store[key] : undefined) : undefined);
  }),
  clear: vi.fn(() => {
  store = {};
  }),
...
class IDBRequest {
  ...
  if (!this.(Object.hasOwn(_listeners, type) ? (Object.hasOwn(_listeners, type) ? _listeners[type] : undefined) : undefined)) {
  this.(Object.hasOwn(_listeners, type) ? (Object.hasOwn(_listeners, type) ? _listeners[type] : undefined) : undefined) = [];
  }
  this.(Object.hasOwn(_listeners, type) ? (Object.hasOwn(_listeners, type) ? _listeners[type] : undefined) : undefined).push(callback);
  }

  removeEventListener(type, callback) {
  if (this.(Object.hasOwn(_listeners, type) ? (Object.hasOwn(_listeners, type) ? _listeners[type] : undefined) : undefined)) {
  this.(Object.hasOwn(_listeners, type) ? (Object.hasOwn(_listeners, type) ? _listeners[type] : undefined) : undefined) = this.(Object.hasOwn(_listeners, type) ? (Object.hasOwn(_listeners, type) ? _listeners[type] : undefined) : undefined).filter(cb => cb !== callback);
  }
  }
...
class IDBObjectStore {
  ...
  setTimeout(() => {
  try {
  const keyToUse = key || ((Object.hasOwn(value, this.keyPath) ? (Object.hasOwn(value, this.keyPath) ? value[this.keyPath] : undefined) : undefined) !== undefined ? (Object.hasOwn(value, this.keyPath) ? (Object.hasOwn(value, this.keyPath) ? value[this.keyPath] : undefined) : undefined) : Date.now());
  this.(Object.hasOwn(_data, keyToUse) ? (Object.hasOwn(_data, keyToUse) ? _data[keyToUse] : undefined) : undefined) = value;
  ...
  try {
  const keyToUse = key || ((Object.hasOwn(value, this.keyPath) ? (Object.hasOwn(value, this.keyPath) ? value[this.keyPath] : undefined) : undefined) !== undefined ? (Object.hasOwn(value, this.keyPath) ? (Object.hasOwn(value, this.keyPath) ? value[this.keyPath] : undefined) : undefined) : Date.now());
  if (this.(Object.hasOwn(_data, keyToUse) ? (Object.hasOwn(_data, keyToUse) ? _data[keyToUse] : undefined) : undefined) !== undefined) {
  ...
  setTimeout(() => {
  try {
  request.result = this.(Object.hasOwn(_data, key) ? (Object.hasOwn(_data, key) ? _data[key] : undefined) : undefined) || null;
  request._triggerSuccess();
  } catch (error) {
  request._triggerError(error);
  }
  ...
  if (!query) {
    ...
    results.push(this.(Object.hasOwn(_data, key) ? (Object.hasOwn(_data, key) ? _data[key] : undefined) : undefined));
    if (count && results.length >= count) { break; }
    }
    }
    request.result = results;
  } else {
    request.result = this.(Object.hasOwn(_data, query) ? (Object.hasOwn(_data, query) ? _data[query] : undefined) : undefined) ? [this.(Object.hasOwn(_data, query) ? (Object.hasOwn(_data, query) ? _data[query] : undefined) : undefined)] : [];
  }
  request._triggerSuccess();
  } catch (error) {
  request._triggerError(error);
  ...
  if (!query) {
    ...
    request.result = this.(Object.hasOwn(_data, query) ? (Object.hasOwn(_data, query) ? _data[query] : undefined) : undefined) ? [query] : [];
  }
  request._triggerSuccess();
  } catch (error) {
  request._triggerError(error);
  ...
  setTimeout(() => {
  try {
  delete this.(Object.hasOwn(_data, key) ? (Object.hasOwn(_data, key) ? _data[key] : undefined) : undefined);
...
class IDBIndex {
  ...
  value = (Object.hasOwn(value, part) ? (Object.hasOwn(value, part) ? value[part] : undefined) : undefined);
  }
  return value;
...
class IDBCursor {
  ...
  this.key = (Object.hasOwn(keys, index) ? (Object.hasOwn(keys, index) ? keys[index] : undefined) : undefined);
  this.primaryKey = (Object.hasOwn(keys, index) ? (Object.hasOwn(keys, index) ? keys[index] : undefined) : undefined);
  this.direction = direction || 'next';
  this.request = null;
  }

  get value() {
  return this.source.(Object.hasOwn(_data, this.primaryKey) ? (Object.hasOwn(_data, this.primaryKey) ? _data[this.primaryKey] : undefined) : undefined);
  }
  ...
  if (nextIndex < this._keys.length) {
    ...
    this.key = this.(Object.hasOwn(_keys, nextIndex) ? (Object.hasOwn(_keys, nextIndex) ? _keys[nextIndex] : undefined) : undefined);
    this.primaryKey = this.(Object.hasOwn(_keys, nextIndex) ? (Object.hasOwn(_keys, nextIndex) ? _keys[nextIndex] : undefined) : undefined);
    request.result = this;
  } else {
    request.result = null;
  }
...
class IDBDatabase {
  ...
  this.(Object.hasOwn(_stores, name) ? (Object.hasOwn(_stores, name) ? _stores[name] : undefined) : undefined) = store;
  return store;
  }

  deleteObjectStore(name) {
  this.objectStoreNames = this.objectStoreNames.filter(storeName => storeName !== name);
  delete this.(Object.hasOwn(_stores, name) ? (Object.hasOwn(_stores, name) ? _stores[name] : undefined) : undefined);
  }
...
const indexedDBMock = {
  ...
  let db = this.(Object.hasOwn(_databases, name) ? (Object.hasOwn(_databases, name) ? _databases[name] : undefined) : undefined);
  const isNewDB = !db;

  if (isNewDB) {
    // Create new database
    db = new IDBDatabase(name, version || 1);
    this.(Object.hasOwn(_databases, name) ? (Object.hasOwn(_databases, name) ? _databases[name] : undefined) : undefined) = db;
  ...
  setTimeout(() => {
  try {
  delete this.(Object.hasOwn(_databases, name) ? (Object.hasOwn(_databases, name) ? _databases[name] : undefined) : undefined);
  request.result = undefined;
  request._triggerSuccess();
  } catch (error) {
  request._triggerError(error);
