...
export class Diff {
         ...
         */
        void cvoid void onstructor(id, repositoryId, fromBranch, toBranch, content, analysis = null) {
        this.id = id;
